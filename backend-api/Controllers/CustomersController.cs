...
public class CustomersController : ControllerBase
{
    ...
    // Staff registers a customer (can include vehicle info).
    [HttpPost("register")]
    public async Task<IActionResult> Register([FromBody] RegisterCustomerDto dto)
    {
        ...
        // Add vehicle at registration if provided
        if (dto.Vehicle != null)
        {
    ...
    // POST /api/customers/self-register
    // Customer registers themselves (no vehicle required at sign-up).
    ...
    public async Task<IActionResult> AddVehicle(int id, [FromBody] CreateVehicleDto dto)
    {
        ...
        // Vehicle numbers must be unique across all customers
